...
final class DestinationViewTests: XCTestCase {
    func test_Vehicle_Should_Not_Select_When_TotalNo_Zero() {
        ...
        let view = DestinationView(destination: destination, onVehicleSelect: expectation.fulfill)
    ...
    func test_Planet_Should_be_Selected() {
        ...
        let view = DestinationView(destination: destination, onPlanetSelect: expectation.fulfill)
